<style>
    /* Chatbox Whatsapp */
:root {
--warna-background: #125D98; /* Warna background header dan tombol chat */
--warna-bg-chat: #5AB7F4;
--warna-icon: #ffff; /* Warna icon chat */
--warna-text: #ffff;
--warna-text-alt: #D9D9D9;
--lebar-chatbox: 350px;
}
...
.chatStart{display: flex;align-items: center;margin-top: 15px;padding: 18px 20px;border-radius: 10px;background-color: #125D98;overflow: hidden;font-size: 12px;color: var(--warna-text)}
...
<label class='chatButton' for='offchatMenu' style='width: 60px; height: 60px;'>
...
<div class='chatBox'>
  ...
  <a class='chatStart' href='https://api.whatsapp.com/send?phone=6289522399121&text=Permisi,%20Saya%20ingin%20bertanya' rel='nofollow noreferrer' target='_blank'>
